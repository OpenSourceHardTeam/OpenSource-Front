...
export const BookInfoDiv16 = css`
  display: flex;
  width: 879px;
  align-items: center;
  justify-content: space-between;
...
export const BookInfoDiv17 = css`
  display: flex;
  flex-direction: column;
  width: 519px;
  align-items: flex-start;
...
export const BookInfoDiv18 = css`
  display: flex;
  flex-direction: column;
  width: 250px;
  align-items: flex-start;
...
export const BookInfoOverlapGroupWrapper = css`
  position: relative;
  width: 250px;
  height: 38px;
  margin-right: -2px;
...
export const BookInfoOverlapGroup = css`
  position: relative;
  letter-spacing: 0;
  line-height: normal;
  display: flex;
