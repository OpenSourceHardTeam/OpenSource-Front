...
const BookInfoPage = () => {
    return <div className="bookinfo-frame">
        <div className="bookinfo-div">
            <div className="bookinfo-group"><div className="bookinfotext-wrapper">Book Information</div></div>
            <div className="bookinfo-div2">
                <div className="bookinfo-view"><img className="bookinfo-image" src={image5} /></div>
                        ...
                        <div className="bookinfo-chat-room-join">
                            <div className="bookinfo-div5">
                                <div className="bookinfo-div6">
                                    <div className="bookinfotext-wrapper4">소년이 온다 채팅방 참여하기</div>
                                    <p className="bookinfotext-wrapper5">여러 사람들과 소년이 온다에 대해 이야기 해봅시다.</p>
                                </div>
                                <div className="bookinfo-div7">
                                    <div className="bookinfo-div8">
                                        ...
                                        <p className="bookinfotext-wrapper7">
                                            지나친 욕설 / 내상언급/ 소통의 여지가 없는 일방적이고 무의미한 글 <br /> 도배 / 지나친 친목/
                                            분란조성 / 수위오버/ 단속/ 카더라 / 타인 신상 언급 등등
                                        </p>
                                    </div>
                                    <div className="bookinfo-div-wrapper"><Button text={"채팅방 참여하기"} /></div>
                                </div>
                            </div>
                        </div>
                    </div>
